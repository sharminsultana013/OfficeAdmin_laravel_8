...
(1, 'ythtyh', 'htyhjuyjuh', 'public/admin/image/1733884717703979.jpg', '2022-05-26 10:35:22'),
...
(1, 'Label', 'from your migration file. That solved it for me. But if you have gone live, then create a new migration just as Alexey has suggested', 'public/admin/image/1733879813686833.jpg', '2022-05-26 09:17:26'),
(3, 'yju7 u y7', 'jujhjhjhjhj', 'public/admin/image/1734038829905892.jpg', '2022-05-28 03:24:55'),
(4, 'njunjkj', 'Our advanced stack uses Apache, Nginx, PHP-FPM, and MySQL/MariaDB to speed up your Laravel site with faster processing.', 'public/admin/image/1734039940056834.jpg', '2022-05-28 03:42:34');
...
(1, 'Advanced Cache', 'Our optimized stack comprises of advanced cache technologies including Memcached, Varnish, and Redis for fast content delivery. Our optimized stack comprises of advanced cache technologies including Memcached, Varnish, and Redis for fast content delivery.', 'public/admin/image/1734040187157186.jpg', '2022-05-28 03:46:30'),
(2, 'HTTP/2 Supported', 'We offer HTTP/2 enabled servers that perform significantly faster by reducing the load on servers. We offer HTTP/2 enabled servers that perform significantly faster by reducing the load on servers. We offer HTTP/2 enabled servers that perform significantly faster by reducing the load on servers.', 'public/admin/image/1734040241374869.jpg', '2022-05-28 03:47:21');
...
(3, 'public/admin/image/1733856315758954.jpg', '2022-05-26 03:03:56'),
(4, 'public/admin/image/1733856327682790.jpg', '2022-05-26 03:04:08');
